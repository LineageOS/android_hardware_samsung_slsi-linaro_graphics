...
const restriction_size_element restriction_size_table_rgb[] =
{
    {{MPP_DPP_GF, NODE_SRC, HAL_PIXEL_FORMAT_NONE, 0},
     {  1,  1,  65535,  8191,   64, 64,   1,  1,  4096,   4096,   64,  64,  1,  1,  1,  1}},
    {{MPP_DPP_VG, NODE_SRC, HAL_PIXEL_FORMAT_NONE, 0},
     {  1,  1,  65535,  8191,   64, 64,  1,  1,  4096,   4096,   64, 64,  1,  1,  1,  1}},
    {{MPP_DPP_VGS, NODE_SRC, HAL_PIXEL_FORMAT_NONE, 0},
     {  2,  8,  65535,  8191,   64, 64,  1,  1,  4096,   4096,   64, 64,  1,  1,  1,  1}},
...
static ppc_table ppc_table_map = {
    ...
    {PPC_IDX(MPP_MSC,PPC_FORMAT_YUV420,PPC_ROT_NO), {4.96, }},
    {PPC_IDX(MPP_MSC,PPC_FORMAT_YUV420,PPC_ROT), {4.70, }},

    {PPC_IDX(MPP_MSC,PPC_FORMAT_YUV422,PPC_ROT_NO), {3.74, }},
    {PPC_IDX(MPP_MSC,PPC_FORMAT_YUV422,PPC_ROT), {3.42, }},

    {PPC_IDX(MPP_MSC,PPC_FORMAT_P010,PPC_ROT_NO), {3.03, }},
    {PPC_IDX(MPP_MSC,PPC_FORMAT_P010,PPC_ROT), {2.88, }},

    {PPC_IDX(MPP_MSC,PPC_FORMAT_YUV8_2,PPC_ROT_NO), {4.61, }},
    {PPC_IDX(MPP_MSC,PPC_FORMAT_YUV8_2,PPC_ROT), {4.59, }},

    {PPC_IDX(MPP_MSC,PPC_FORMAT_RGB32,PPC_ROT_NO), {1.89, }},
    {PPC_IDX(MPP_MSC,PPC_FORMAT_RGB32,PPC_ROT), {1.88, }},

    {PPC_IDX(MPP_MSC,PPC_FORMAT_SBWC,PPC_ROT_NO), {4.79, }},
    {PPC_IDX(MPP_MSC,PPC_FORMAT_SBWC,PPC_ROT), {4.36, }}
};
