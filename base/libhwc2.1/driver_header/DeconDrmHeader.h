...
struct drm_dpu_ch_restriction {
    struct dpu_res_u32 id;
    struct dpu_res_u32 port;
    struct dpu_res_u32 dpuf_id;
    struct dpu_res_u64 attr;
    struct dpu_res_u32_range src_f_w;
    struct dpu_res_u32_range src_f_h;
    struct dpu_res_u32_range src_w;
    struct dpu_res_u32_range src_h;
    struct dpu_res_u32 src_x_align;
    struct dpu_res_u32 src_y_align;

    struct dpu_res_u32_range src_rgb_comp_f_w;
    struct dpu_res_u32_range src_rgb_comp_w;
    struct dpu_res_u32_range src_rgb_comp_f_h;
    struct dpu_res_u32_range src_rgb_comp_h;

    struct dpu_res_u32_range dst_f_w;
    struct dpu_res_u32_range dst_f_h;
    struct dpu_res_u32_range dst_w;
    struct dpu_res_u32_range dst_h;
    struct dpu_res_u32 dst_x_align;
    struct dpu_res_u32 dst_y_align;

    struct dpu_res_u32_range blk_w;
    struct dpu_res_u32_range blk_h;
    struct dpu_res_u32 blk_x_align;
    struct dpu_res_u32 blk_y_align;

    struct dpu_res_u32 src_w_rot_max;
    struct dpu_res_u32 src_h_rot_max;

    struct dpu_res_u32 scale_down;
    struct dpu_res_u32 scale_up;
};
